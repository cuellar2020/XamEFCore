...
namespace XamEFCore.ViewModels
{
    public class AlbumesViewModel : BaseViewModel
    {
        ...
        private void CreateArtistas()
        {
            ...
            {
                new Artista { Nombre = "Doja Cat" },
                new Artista { Nombre = "Ashininko" },
                new Artista { Nombre = "The Weekend" },
                new Artista { Nombre = "Rihanna" },
                new Artista { Nombre = "Dove Cameron" },
                new Artista { Nombre = "Dua Lipa" }
            };
